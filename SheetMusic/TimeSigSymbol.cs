...
public class TimeSigSymbol : MusicSymbol {
    ...
    private static void LoadImages() {
        if (images == null) {
            ...
            images[2] = Resource.two;//new Bitmap(typeof(TimeSigSymbol), "two.png");
            images[3] = Resource.three;//new Bitmap(typeof(TimeSigSymbol), "three.png");
            images[4] = Resource.four;//new Bitmap(typeof(TimeSigSymbol), "four.png");
            images[6] = Resource.six;//new Bitmap(typeof(TimeSigSymbol), "six.png");
            images[8] = Resource.eight;//new Bitmap(typeof(TimeSigSymbol), "eight.png");
            images[9] = Resource.nine;//new Bitmap(typeof(TimeSigSymbol), "nine.png");
            images[12] = Resource.twelve;//new Bitmap(typeof(TimeSigSymbol), "twelve.png");
        }
    }
