...
public class MidiEvent : IComparer<MidiEvent> {
    public const float DEFAULT_BPM = 120.0f;
    public const int DEFAULT_MPQN = (int) (60000000 / DEFAULT_BPM);
    ...
    public override string ToString()
    {
        return "StartTime:"    + StartTime + 
               " EventFlag:0x" + EventFlag.ToString("x") +  
               " Stem: 0x"        + Notenumber.ToString("x") +
               " Channel:"     + Channel ;
    }
}
